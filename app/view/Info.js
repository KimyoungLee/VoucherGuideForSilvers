	        	...
	        	items:[
			        {
						...
						scrollable: true,
						html:'<div id="infoContent"><h3>목적</h3>혼자 힘으로 일상생활을 영위하기 어려운 노인과 독거노인에게 욕구에 따라 안전확인, 생활교육, 서비스 연계, 가사·활동지원, 주간보호서비스 등 맞춤형 복지서비스 제공</div>'			        
			        },
			        {
			        	xtype: 'panel',
						style:{
			        ...
			        },
			        {
						...
						scrollable: true,
						html:'<div id="infoContent"><h3>서비스 가격</h3><ul><li>서비스 대상자의 소득 및 서비스 시간(일)에 따라 바우처 지원금을 차등 지원</li></ul><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><th>&nbsp;</th><th>&nbsp;</th><th>서비스가격</th><th>&nbsp;</th><th>정부지원금</th><th>&nbsp;</th><th>본인부담금</th></tr><tr><th rowspan="3">월 27시간 (9일)</th><td>차상위 초과</td><td>월 248,400원</td><td rowspan="6">=</td><td>월 212,400원</td><td rowspan="6">+</td><td>월 36,000원</td></tr><tr><td>차상위 계층</td><td>월 248,400원</td><td>월 230,400원</td><td>월 18,000원</td></tr><tr><td>기초생활수급자</td><td>월 248,400원</td><td>월 248,400원</td><td>무료</td></tr><tr><th rowspan="3">월 36시간 (12일)</th><td>차상위 초과</td><td>월 331,200원</td><td>월 283,200원</td><td>월 48,000원</td></tr><tr><td>차상위 계층</td><td>월 331,200원</td><td>월 307,200원</td><td>월 24,000원</td></tr><tr><td>기초생활수급자</td><td>월 331,200원</td><td>월 322,920원</td><td>월 8,280원</td></tr></table><ul><li>본인부담금 납부 기한 및 방법<br/>- (원칙) 매월 15~27일까지, (추가연장) 익월 1~10일까지<br/>- 결정통지서 및 바우처 카드에 명시된 지정 계좌에 무통장송금, 인터넷·폰뱅킹·ATM 등을 통해 본인부담금을 입금(예금주 : 서비스 대상자명)<br/>※ 본인부담금을 입금하지 않으면 바우처가 생성되지 않음에 유의</li></ul></div>'			        
			        },
			        {
			        	xtype: 'panel',
						style:{
						...
						scrollable: true,
						html:'<div id="infoContent"><h3>서비스 신청</h3><ul><li>신청권자 : 본인, 가족 또는 그 밖의 관계인</li><li>신청서 제출 장소 : 서비스 대상자의 주민등록상 주소지 읍·면·동 주민센터</li><li>신청기간 : 매월 1일 ~ 18일 (익월 1일부터 서비스 개시)</li><li>제출서류 : 신청서 등은 읍·면·동 주민센터에 비치되어 있으며, 신분증과 소득증명 자료 필요<br/>※ 제출서류는 방문 전 읍·면·동 주민센터로 문의</li></ul></div>'			        
			        },
			        {
			        	xtype: 'panel',
						style:{
